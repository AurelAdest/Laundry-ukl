...
public class Laporan {
     public void laporan(JenisLaundry barang){ //method tipe void
    ...
    public void laporan (Petugas petugas){//class
        System.out.println("Nama Petugas \t\tAlamat \t\tTelepon \tJabatan");//deklarasi output
        ...
        //karna nama methodnya di laporan
        }
        public void laporan(Client member){ //method
            int x=member.getJmlClient();//diambil dari parameter
